...
let nombre = "Iñigo";
let saludo = `Hola, ${nombre} bienvenido`; //! en este caso las backticks nos permiten agregar variables dentro de la string

console.log(saludo);

// Plantillas HTML
let plantilla = `   //! permiten el salto de línea dentro de la string -- nos permite introducir HTML dentro de Js como plantillas
<html>
