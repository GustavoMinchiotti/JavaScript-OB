...
function saludar(nombre) {
  //* con la sintaxis ${....} inserto el parámetro dentro de la string. // en el caso de undefined es porque no tiene parámetro
...
function despedir(nombre) {
  //* pero al crear dentro de la func. otro parámetro ese queda expresado extiendo solo dentro de la misma.
  nombre = "Diego";
...
function imprimir(...parametros) {
  //* con el factor de propagación puedo pasar un objeto como parámetro
...
function suma(...nums) {
  //* en este caso hay varios ejemplos, con los métodos y el factor de propagación puedo imprimir un indice el array completo etc. 
  return nums.reduce((a, b) => a + b);      //! si no uso la palabra reservada return no guarda el valor en la variable
}
...
function multiplicar(a = 0, b = 0) {
  ...
  let variable_interna = "adiós"; //* solo accedo desde dentro de la función
